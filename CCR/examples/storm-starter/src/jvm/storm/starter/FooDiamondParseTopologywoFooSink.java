 ...
 * </p>
 */
public class FooDiamondParseTopologywoFooSink {
    private static final Logger LOG = LoggerFactory.getLogger(FooDiamondParseTopologywoFooSink.class);
...
//        builder.setSpout("spout", new fooRandomIntegerWithCHKPTSpout());
        ...
        builder.setBolt("fooPartial3", new fooXMLParser("3"), 1).shuffleGrouping("spout","datastream")
                .allGrouping("spout","PREPARE_STREAM_ID");
        builder.setBolt("fooPartial4", new fooXMLParser("4"), 1).shuffleGrouping("spout","datastream")
                .allGrouping("spout","PREPARE_STREAM_ID");

        builder.setBolt("fooPartial5", new fooXMLParser("5"), 1).shuffleGrouping("spout","datastream")
                .allGrouping("spout","PREPARE_STREAM_ID");
