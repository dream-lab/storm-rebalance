 ...
 * </p>
 */
public class FooDoubleDiamondTopologyWithFooSink {
    private static final Logger LOG = LoggerFactory.getLogger(FooDoubleDiamondTopologyWithFooSink.class);
...
//        builder.setSpout("spout", new fooRandomIntegerWithCHKPTSpout());
        builder.setBolt("fooPartial2", new foo("2"), 1).shuffleGrouping("spout","datastream").setNumTasks(4)
                .allGrouping("spout","PREPARE_STREAM_ID");
        builder.setBolt("fooPartial3", new foo("3"), 1).shuffleGrouping("fooPartial2").setNumTasks(4)
                .allGrouping("spout","PREPARE_STREAM_ID");
        builder.setBolt("fooPartial4", new foo("4"), 1).shuffleGrouping("fooPartial2").setNumTasks(4)
                .allGrouping("spout","PREPARE_STREAM_ID");

        builder.setBolt("fooPartial5", new foo("5"), 1).setNumTasks(4)
                .shuffleGrouping("fooPartial3")
                .shuffleGrouping("fooPartial4")
                .allGrouping("spout","PREPARE_STREAM_ID");

        builder.setBolt("fooPartial6", new foo("6"), 1).shuffleGrouping("fooPartial5").setNumTasks(4)
                .allGrouping("spout","PREPARE_STREAM_ID");
        builder.setBolt("fooPartial7", new foo("7"), 1).shuffleGrouping("fooPartial5").setNumTasks(4)
                .allGrouping("spout","PREPARE_STREAM_ID");

        builder.setBolt("fooPartial8", new foo("8"), 1).setNumTasks(4)
                .shuffleGrouping("fooPartial6")
                .shuffleGrouping("fooPartial7")
                .allGrouping("spout","PREPARE_STREAM_ID");

//        builder.setBolt("sink", new Sink(sinkLogFileName), 1).shuffleGrouping("fooPartial8");
        builder.setBolt("sink", new fooSink(sinkLogFileName), 1).shuffleGrouping("fooPartial8")
                .allGrouping("spout","PREPARE_STREAM_ID");
