...
//        builder.setSpout("spout", new fooRandomIntegerWithCHKPTSpout());
        ...
        builder.setBolt("fooPartial9", new fooXMLParser("9"), 1).shuffleGrouping("fooPartial4");

        builder.setBolt("fooPartial10", new fooXMLParser("10"), 1).shuffleGrouping("fooPartial9");
        builder.setBolt("fooPartial11", new fooXMLParser("11"), 1).shuffleGrouping("fooPartial9");
        builder.setBolt("fooPartial12", new fooXMLParser("12"), 1).shuffleGrouping("fooPartial9");
        ...
        builder.setBolt("fooPartial15", new fooXMLParser("15"), 3).shuffleGrouping("fooPartial14");
        builder.setBolt("fooPartial16", new fooXMLParser("16"), 3).shuffleGrouping("fooPartial15");
