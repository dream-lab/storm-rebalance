...
//        System.setOut(new PrintStream(new FileOutputStream("/Users/anshushukla/data/output/SIGNALS/log_file.txt")));

        String logFilePrefix = argumentClass.getTopoName() + "-" + argumentClass.getExperiRunId() + "-" + argumentClass.getScalingFactor() + ".log";
        String sinkLogFileName = argumentClass.getOutputDirName() + "/sink-" + logFilePrefix+ UUID.randomUUID();
...
//        builder.setSpout("spout", new fooRandomIntegerWithCHKPTSpout());
        ...
        builder.setBolt("fooPartial3", new foo("3"), 1).shuffleGrouping("fooPartial2")
                .allGrouping("spout","PREPARE_STREAM_ID");
        ...
        builder.setBolt("sink", new fooSink(sinkLogFileName), 1).shuffleGrouping("fooPartial5")
                .allGrouping("spout","PREPARE_STREAM_ID");
//        builder.setBolt("sink", new Sink(sinkLogFileName), 1).shuffleGrouping("fooPartial5");
...
//        conf.put(Config.TOPOLOGY_TICK_TUPLE_FREQ_SECS,1);
        conf.put(Config.NIMBUS_MONITOR_FREQ_SECS,2);
