...
//        builder.setSpout("spout", new fooRandomIntegerWithCHKPTSpout());
        ...
        builder.setBolt("fooPartial2", new fooSleep("2"), 1).shuffleGrouping("spout").directGrouping("spout", PREPARE_STREAM_ID_list[0]);
        builder.setBolt("fooPartial3", new fooSleep("3"), 1).shuffleGrouping("fooPartial2").directGrouping("spout", PREPARE_STREAM_ID_list[1]);
        builder.setBolt("fooPartial4", new fooSleep("4"), 1).shuffleGrouping("fooPartial3").directGrouping("spout", PREPARE_STREAM_ID_list[2]);
        builder.setBolt("fooPartial5", new fooSleep("5"), 1).shuffleGrouping("fooPartial4").directGrouping("spout", PREPARE_STREAM_ID_list[3]);
        builder.setBolt("fooPartial6", new fooSleep("6"), 1).shuffleGrouping("fooPartial5").directGrouping("spout", PREPARE_STREAM_ID_list[4]);
        ...
        builder.setBolt("fooPartial9", new fooSleep("9"), 1).shuffleGrouping("fooPartial4").directGrouping("spout", PREPARE_STREAM_ID_list[7]);

        builder.setBolt("fooPartial10", new fooSleep("10"), 1).shuffleGrouping("fooPartial9").directGrouping("spout", PREPARE_STREAM_ID_list[8]);
        builder.setBolt("fooPartial11", new fooSleep("11"), 1).shuffleGrouping("fooPartial9").directGrouping("spout", PREPARE_STREAM_ID_list[9]);
        builder.setBolt("fooPartial12", new fooSleep("12"), 1).shuffleGrouping("fooPartial9").directGrouping("spout", PREPARE_STREAM_ID_list[10]);
        ...
        builder.setBolt("fooPartial15", new fooSleep("15"), 3).shuffleGrouping("fooPartial14").directGrouping("spout", PREPARE_STREAM_ID_list[13]);
        builder.setBolt("fooPartial16", new fooSleep("16"), 3).shuffleGrouping("fooPartial15").directGrouping("spout", PREPARE_STREAM_ID_list[14]);
