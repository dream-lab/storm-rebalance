...
//        builder.setSpout("spout", new fooRandomIntegerWithCHKPTSpout());
        builder.setBolt("fooPartial2", new foo("2"), 1).shuffleGrouping("spout","datastream");
        builder.setBolt("fooPartial3", new foo("3"), 1).shuffleGrouping("fooPartial2").setNumTasks(4);
        builder.setBolt("fooPartial4", new foo("4"), 1).shuffleGrouping("fooPartial2");

        builder.setBolt("fooPartial5", new foo("5"), 1)
                .shuffleGrouping("fooPartial3")
                .shuffleGrouping("fooPartial4");

        builder.setBolt("fooPartial6", new foo("6"), 1).shuffleGrouping("fooPartial5");
        builder.setBolt("fooPartial7", new foo("7"), 1).shuffleGrouping("fooPartial5");

        builder.setBolt("fooPartial8", new foo("8"), 1)
