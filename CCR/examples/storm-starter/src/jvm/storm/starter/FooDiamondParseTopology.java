...
//        builder.setSpout("spout", new fooRandomIntegerWithCHKPTSpout());
        builder.setBolt("fooPartial2", new fooXMLParser("2"), 1).shuffleGrouping("spout")
                .directGrouping("spout", PREPARE_STREAM_ID_list[0]);
        builder.setBolt("fooPartial3", new fooXMLParser("3"), 1).shuffleGrouping("spout")
                .directGrouping("spout", PREPARE_STREAM_ID_list[1]);
        builder.setBolt("fooPartial4", new fooXMLParser("4"), 1).shuffleGrouping("spout")
                .directGrouping("spout", PREPARE_STREAM_ID_list[2]);

        builder.setBolt("fooPartial5", new fooXMLParser("5"), 1).shuffleGrouping("spout")
