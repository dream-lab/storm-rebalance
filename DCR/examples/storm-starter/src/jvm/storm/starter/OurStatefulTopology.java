 ...
 * </p>
 */
public class OurStatefulTopology {
    private static final Logger LOG = LoggerFactory.getLogger(OurStatefulTopology.class);
    /**
    ...
    private static class StatefulSumBolt extends BaseStatefulBolt<KeyValueState<String, Long>> {
        ...
        public void execute(Tuple input) {
            ...
            kvState.put("sum1", sum);
            System.out.println("UPDATED state MAP:"+kvState.toString()+"-KEY:"+kvState.get("sum1"));
        ...
        public void initState(KeyValueState<String, Long> state) {
            ...
            sum = kvState.get("sum1", 0L);
            LOG.debug("Initstate, sum from saved state = {} ", sum);
            System.out.println("OLD state:"+sum);
...
//            LOG.debug("Got tuple {}", tuple);
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("partialsum2", new StatefulSumBolt("partial"), 2).shuffleGrouping("spout").setNumTasks(4);
