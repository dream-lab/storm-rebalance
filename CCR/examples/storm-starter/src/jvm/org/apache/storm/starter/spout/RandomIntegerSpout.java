...
public class RandomIntegerSpout extends BaseRichSpout {
    ...
    public void nextTuple() {
        ...
        val+=1;
//        if(val<10000) {
            collector.emit(new Values(val, System.currentTimeMillis() - (24 * 60 * 60 * 1000), ++msgId), msgId);
//        collector.emit(new Values(val, System.currentTimeMillis() - (24 * 60 * 60 * 1000), ++msgId));
//        }
    }
