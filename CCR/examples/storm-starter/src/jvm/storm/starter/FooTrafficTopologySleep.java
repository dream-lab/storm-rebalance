 ...
 * </p>
 */
public class FooTrafficTopologySleep {
    private static final Logger LOG = LoggerFactory.getLogger(FooTrafficTopologySleep.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("fooPartial7", new fooSleep("7"), 1).shuffleGrouping("fooPartial5")
                .directGrouping("spout", PREPARE_STREAM_ID_list[5]);;
        builder.setBolt("fooPartial8", new fooSleep("8"), 1).shuffleGrouping("fooPartial5")
                .directGrouping("spout", PREPARE_STREAM_ID_list[6]);;


        builder.setBolt("fooPartial9", new fooSleep("9"), 1).shuffleGrouping("fooPartial6")
                .directGrouping("spout", PREPARE_STREAM_ID_list[7]);;
        builder.setBolt("fooPartial10", new fooSleep("10"), 1).shuffleGrouping("fooPartial6")
                .directGrouping("spout", PREPARE_STREAM_ID_list[8]);;

        builder.setBolt("fooPartial11", new fooSleep("11"), 1).shuffleGrouping("fooPartial9")
                .directGrouping("spout", PREPARE_STREAM_ID_list[9]);;

        builder.setBolt("fooPartial12", new fooSleep("12"), 3)
                .shuffleGrouping("fooPartial10")
                .shuffleGrouping("fooPartial11")
                .shuffleGrouping("fooPartial7")
                .directGrouping("spout", PREPARE_STREAM_ID_list[10]);;
